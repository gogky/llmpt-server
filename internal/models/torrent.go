...
type Torrent struct {
	...
	InfoHash    string             `bson:"info_hash" json:"info_hash"`                           // canonical torrent identity（pure v2 下为完整 64 hex）
	AnnounceKey string             `bson:"announce_key,omitempty" json:"announce_key,omitempty"` // tracker swarm key（pure v2 下为 40 hex truncated）
